 <!--footer start-->
              ...
              <div class="row">
                <div class="col-md-4">
                  <aside class="widget widget_text">
                    ...
                    <p>In 2015, We launched Unique Fly with the belief that other travellers would share our desire to experience authentic adventures in a responsible and sustainable manner. <br> <br> We've grown from a one-man show to a company of over 50 world wide, and from a handful of trips in all over the world. </p>
                ...
                <div class="col-md-4">
                  <aside class="widget widget_recent_entries">
                    <h4 class="widget-title">Testimonies</h4>
                    <ul>
                      <li>
                        <img src="images/flights/project01.jpg" alt="Recent blog" />
                        <div>
                          <p>Hey i'm Tanya Unique Fly is the best on this planet, what are you waiting for book now..</p>
                         
                        </div>
                      </li>
                      <li>
                        <img src="images/flights/harvey.jpg" alt="Recent blog" />
                        <div>
                          <p>I'm Harvey Spector the planet I come from Unique Fly is on top of the list..</p>
                ...
                <div class="col-md-4">
                  <aside class="widget widget_search_availability">
                      ...
                      <ul>
                        <li>
                          <a href="#widget_global_search">
                            <svg version="1.1" id="widget_global_search_icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="48.999px" height="48.999px" viewBox="0 0 48.999 48.999" style="enable-background:new 0 0 48.999 48.999;" xml:space="preserve">
                              <g>
                        ...
                        <li>
                          <a href="#widget_hotal_search">
                            <svg version="1.1" id="widget_hotal_search_icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="510px" height="510px" viewBox="0 0 510 510" style="enable-background:new 0 0 510 510;" xml:space="preserve">
                              <g>
                                <g id="hotel">
                        ...
                        <li>
                          <a href="#widget_flight_search">
                            <svg version="1.1" id="widget_flight_search_icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 375.04 375.04" style="enable-background:new 0 0 375.04 375.04;" xml:space="preserve">
                              <g>
                                <g id="Layer_5_77_">
                        ...
                        <li>
                          <a href="#widget_local_search">
                            <svg version="1.1" id="widget_local_search_icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="444.103px" height="444.103px" viewBox="0 0 444.103 444.103" style="enable-background:new 0 0 444.103 444.103;" xml:space="preserve">
                              <g>
                    ...
                    <div id="widget_global_search" class="wsa_tab_content">
                      <form>
                        ...
                        <div class="travel_form_element"> <label>Check in date</label> <input type="text" id="Check_in_date_global_search" placeholder="dd/mm/yyyy"> <i class="fa fa-calendar"></i> </div>
                        <div class="travel_form_element"> <label>Check out date</label> <input type="text" id="Check_out_date_global_search" placeholder="dd/mm/yyyy"> <i class="fa fa-calendar"></i> </div>
                        <div class="travel_form_element">
                        ...
                        <div class="travel_form_element"> <button type="submit" class="btn-travel btn-yellow">Search</button> </div>
                      </form>
                    </div>
                    <div id="widget_hotal_search" class="wsa_tab_content">
                      <form>
                        ...
                        <div class="travel_form_element"> <label>Check in date</label> <input type="text" id="Check_in_date_hotal_search" placeholder="dd/mm/yyyy"> <i class="fa fa-calendar"></i> </div>
                        <div class="travel_form_element"> <label>Check out date</label> <input type="text" id="Check_out_date_hotal_search" placeholder="dd/mm/yyyy"> <i class="fa fa-calendar"></i> </div>
                        <div class="travel_form_element">
                          ...
                          <select class="selectpicker" title="Accomodation">
                            ...
                            <option data-tokens="Bed & Breakfast">Bed & Breakfast</option>
                          </select>
                        </div>
                        <div class="travel_form_element"> <label>Rooms</label> <input type="number" placeholder="No of rooms"> </div>
                        <div class="travel_form_element">
                          <label>Max-Budget</label> 
                          <select class="selectpicker" data-live-search="true" title="your Max-Budget">
                            <option data-tokens="Rs. 2000 and Below">Rs. 2000 and Below"</option>
                      ...
                      <form>
                        ...
                        <div class="travel_form_element">
                          ...
                          <select class="selectpicker" title="Flight Name">
                            ...
                            <option data-tokens="US Airways (520)">US Airways (520)</option>
                            <option data-tokens="Air France (500)">Air France (500)</option>
                            <option data-tokens="Olympic (120)">Olympic (120)</option>
                            <option data-tokens="Emirates (280)">Emirates (280)</option>
                          </select>
                        </div>
                        <div class="travel_form_element">
                      ...
                      <form>
                        ...
                        <div class="travel_form_element">
                          ...
                          <select class="selectpicker" multiple data-live-search="true" title="Typology">
                            ...
                            <option data-tokens="stay shorter periods">stay shorter periods</option>
                            <option data-tokens="spend less">spend less</option>
                            <option data-tokens="prefer family road trips (take more things)">prefer family road trips (take more things)</option>
                            <option data-tokens="mobile homes & lower costs">mobile homes & lower costs</option>
                            <option data-tokens="friends & family">friends & family</option>
                            <option data-tokens="visit familiar tourist spots">visit familiar tourist spots</option>
                            <option data-tokens="travel more by air">travel more by air</option>
                        ...
                        <div class="travel_form_element"> <label>Check in date</label> <input type="text" id="Check_in_date_local_search" placeholder="dd/mm/yyyy"> <i class="fa fa-calendar"></i> </div>
                        <div class="travel_form_element"> <label>Check out date</label> <input type="text" id="Check_out_date_local_search" placeholder="dd/mm/yyyy"> <i class="fa fa-calendar"></i> </div>
                        <div class="travel_form_element">
                          <label>Max-Budget</label> 
                          <select class="selectpicker" data-live-search="true" title="your Max-Budget">
                            <option data-tokens="Rs. 2000 and Below">Rs. 2000 and Below"</option>
                  ...
                  <aside class="widget payment_method">
                    ...
                    <a href=""><img src="images/Payment-Images.png" alt="Payment Method" /></a>
                  </aside>
                </div>
              </div>
            </div>
          ...
          <div class="copyright">
            <div class="container">
              <div class="row">
                <div class="col-md-6 col-sm-6"> <span>Unique Fly@2016. All Right Reserved</span> 
        ...
        <!--counter js-->
        <script type="text/javascript" src="js/plugin/counter/jquery.countdown.js"></script>
        <!-- REVOLUTION JS FILES -->
        ...
        <script type="text/javascript" src="js/plugin/revolution/js/revolution.extension.layeranimation.m in.js"></script>
        ...
        <!-- REVOLUTION JS FiLES -->
        <!-- video_popup -->
        <script type="text/javascript" src="js/plugin/video-popup/jquery.magnific-popup.js"></script>
        <!-- video_popup -->
        <!-- slick slider -->
